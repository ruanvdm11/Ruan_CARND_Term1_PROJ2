...
Here is an exploratory visualization of the data set. It is a bar chart showing how the data is divided between the given training set and the testing set.
